...
/*  created() {
fetch('https://api.exchangeratesapi.io/latest?base=USD&symbols=MXN').then(response => response.json())
  .then(data => console.log(data));
  }
};*/
 created() {
axios.get("https://api.exchangeratesapi.io/latest?base=USD&symbols=MXN").then((result) => {
